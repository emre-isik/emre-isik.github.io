...
Through numerical simulations and data analysis, I explore physical mechanisms (mostly through MHD simulations) underlying observed magnetic activity patterns on the Sun and other Sun-like stars. When I am not wrangling with models in the theoretical world of wonders, I contribute to observational studies of stellar magnetic activity. Thanks to my recent years of teaching and supervising in (astro)informatics, I have enriched my toolbox with machine-learning methods. In a recent excursion to astrobiology, I worked on modelling thermodynamics of organic reaction networks in ocean-world interiors. Click on the links below to see my research summaries. 

<span style="font-size:1.25em">📚 See my</span> [<span style="font-size:1.25em">live bibliography at ADS</span>](https://ui.adsabs.harvard.edu/search/p_=0&q=%20author%3A%22Isik%2C%20Emre%22&sort=date%20desc%2C%20bibcode%20desc){:target="_blank" rel="noopener noreferrer"}. 
...
🚨 **NEWS** (update 25.05.2026) -- In June 2025, I co-organised an ISSI Workshop at the International Space Science Institute (Bern, Switzerland), entitled [**Stellar Magnetism and its Impact on (Exo)planets**](https://workshops.issibern.ch/stellar-magnetism/). The knowledge gathered around the workshop has been compiled to a book of six chapters. I led the chapter _"Magnetic activity in cool stars: manifestations and relevance to exoplanets"_, recently submitted to Space Science Reviews. 

🚨 **NEWS** (12.01.2026) -- The Japanese-Turkish joint research project **Exploring The Connection Between Chromospheric Activity and Starspots in Late-Type Active Stars: Implications for Dynamo Evolution** (2026-2028) has been awarded funding from JSPS and TUBITAK! I am a consultant and collaborator in the project, co-led by H.V. Şenavcı (Ankara University) and D. Nogami (Kyoto University).
